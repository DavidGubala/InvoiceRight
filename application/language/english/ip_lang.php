...
$lang = [
    ...
    'billcom_client_enabled_help'  => 'When enabled, invoices for this client can be sent to Bill.com',
    'billcom_status'               => 'Bill.com Status',
    'client_billcom_customer_id'   => 'Bill.com Customer ID',
    'client_billcom_customer_id_help' => 'Optional: If this client exists in Bill.com, enter their Customer ID (starts with 0cu). Leave blank to create a new customer.',
    'billcom_client_no_email_or_id' => 'Client must have an email address or Bill.com Customer ID',
