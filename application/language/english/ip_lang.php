...
$lang = [
    ...
    'billcom_send_invoice'         => 'Send to Bill.com',
    'billcom_send_batch'           => 'Send Selected to Bill.com',
    'billcom_success'              => 'Successfully sent to Bill.com',
    'billcom_error'                => 'Error sending to Bill.com',
    'billcom_already_sent'         => 'Already sent to Bill.com',
    'billcom_sent_on'              => 'Sent to Bill.com on',
    'billcom_settings'             => 'Bill.com Settings',
    'billcom_username'             => 'Bill.com Username/Email',
    'billcom_password'             => 'Bill.com Password',
    'billcom_dev_key'              => 'Bill.com Developer Key',
    'billcom_org_id'               => 'Bill.com Organization ID',
    'billcom_api_url'              => 'Bill.com API URL',
    'billcom_enabled'              => 'Enable Bill.com Integration',
    'billcom_not_enabled'          => 'Bill.com integration is not enabled',
    'billcom_no_items'             => 'Invoice has no items to send',
    'billcom_no_invoices_selected' => 'No invoices selected',
    'billcom_batch_success'        => 'Successfully sent invoices to Bill.com',
    'billcom_batch_errors'         => 'Some invoices failed to send',
    'billcom_test_connection'      => 'Test Connection',
    'billcom_id'                   => 'Bill.com ID',
    'billcom_login_failed'         => 'Failed to login to Bill.com',
    'billcom_session_expired'      => 'Bill.com session expired, logging in again',
    'client_billcom_enabled'       => 'Enable Bill.com Integration',
    'billcom_client_disabled'      => 'Bill.com integration not enabled for this client',
    'billcom_client_enabled_help'  => 'When enabled, invoices for this client can be emailed as PDFs to their Bill.com submission email address.',
        'billcom_status'               => 'Bill.com Status',
        'client_billcom_customer_id'   => 'Bill.com Customer ID (Legacy API)',
        'client_billcom_customer_id_help' => 'Optional: Legacy API field. For the current email-based integration, use the Bill.com Email Address field above instead.',
        'billcom_client_no_email_or_id' => 'Client must have a Bill.com email address configured',
        'billcom_send_confirm'         => 'Send',
    'billcom_email_subject'        => 'Invoice %s - Ted G Trailer Repair',
    'billcom_email_body'           => '<p>Please find attached invoice <strong>#%s</strong> for <strong>%s</strong> in the amount of <strong>%s</strong>.</p><p>Trailer Number: <strong>%s</strong></p><p>This invoice was sent from Ted G Trailer Repair.</p>',
    'billcom_email_success'        => 'Invoice PDF successfully emailed to client\'s Bill.com address',
    'billcom_email_error'          => 'Failed to email invoice PDF. Please check your SMTP email configuration.',
    'billcom_email_not_configured' => 'No Bill.com email address configured for this client. Please add one in the client form.',
    'billcom_mailer_not_configured' => 'Email is not configured. Please set up SMTP email in Settings > Email first.',
    'billcom_email'                => 'Bill.com Email Address',
    'billcom_email_help'           => 'The email address where this client\'s Bill.com receives invoices. Emailing the PDF to this address submits the invoice to their Bill.com system.',
    'client_billcom_email'         => 'Bill.com Email Address',
    'client_billcom_email_help'    => 'Enter the email address for this client\'s Bill.com invoice submission. Invoice PDFs will be emailed here.',
