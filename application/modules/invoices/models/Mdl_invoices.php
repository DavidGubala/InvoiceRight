...
class Mdl_Invoices extends Response_Model
{
    ...
    {
        $this->db->order_by('ip_invoices.invoice_date_created DESC, LENGTH(ip_invoices.invoice_number) DESC, ip_invoices.invoice_number DESC, ip_invoices.invoice_id DESC');
    }
